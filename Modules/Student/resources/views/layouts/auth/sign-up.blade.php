                    ...
                    <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
                        <div class="card card-plain">
                            <div class="card-header">
                                <h4 class="font-weight-bolder">Sign Up As A Student</h4>
                            ...
                            <div class="card-body">
                                ...
                                @if($errors->has('email'))
                                    ...
                                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                        <span
                                            class="alert-text"><strong>Error!</strong> {{ $errors->first('email') }}</span>
                                        <button type="button" class="btn-close" data-bs-dismiss="alert"
                                                aria-label="Close">
                                            <span aria-hidden="true"></span>
                                        </button>
                                ...
                                @endif
                                <form method="POST" action="{{route('student.signing.up')}}" role="form">
                                    @csrf
                                    ...
                                    <div class="text-center">
                                        <button type="submit"
                                                class="btn btn-lg bg-gradient-secondary shadow-secondary btn-lg w-100 mt-4 mb-0">
                                            Sign Up
                                        </button>
                                    </div>
                                </form>
                            ...
                            <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                <p class="mb-2 text-sm mx-auto">
                                    ...
                                    <a href="{{route('show.student.login.form')}}"
                                       class="text-secondary font-weight-bold">Sign in</a>
                                </p>
                            </div>
                        </div>
                    </div>
