                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-12">
                                    <div class="input-group input-group-outline is-valid my-3">
                                        ...
                                        <input type="text" name="questions[{{ $i }}][answer][{{ 0 }}]" class="form-control" value="{{$exam->questions[$i]->answers[0]->answer_text}}"  disabled>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="input-group input-group-outline is-invalid my-3">
                                        <label class="form-label">Wrong Choice</label>
                                        <input type="text" name="questions[{{ $i }}][answer][{{ 1 }}]" class="form-control" value="{{$exam->questions[$i]->answers[1]->answer_text}}" disabled>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="input-group input-group-outline is-invalid my-3">
                                        <label class="form-label">Wrong Choice</label>
                                        <input type="text" name="questions[{{ $i }}][answer][{{ 2 }}]" class="form-control" value="{{$exam->questions[$i]->answers[2]->answer_text}}" disabled>
                                    </div>
                                </div>
                            </div>
                            <hr class="my-4"
