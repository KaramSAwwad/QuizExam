...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-secondary" id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="#" target="_blank">
            ...
            <span class="ms-1 font-weight-bold text-white">Teachers Panel</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link text-white {{ Route::is('teacher.show.dashboard') ? 'active bg-gradient-info' : '' }} " href="{{route('teacher.show.dashboard')}}">
            ...
            <li class="nav-item">
                ...
                {{ Route::is('teacher.show.exams') ? 'active bg-gradient-info' : '' }}
                {{ Route::is('teacher.show.create.new.exam.form') ? 'active bg-gradient-info' : '' }}
                {{ Route::is('teacher.fill.exam.questions') ? 'active bg-gradient-info' : '' }}
                {{ Route::is('teacher.show.edit.exam.form') ? 'active bg-gradient-info' : '' }}
                {{ Route::is('teacher.previewExam.exam') ? 'active bg-gradient-info' : '' }}
                  " href="{{route('teacher.show.exams')}}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
