...
!function () {
    ...
    var e = window.document, o = e.location, t = window.Math, r = window.HTMLElement, a = window.XMLHttpRequest,
        ...
        s = d && r && "attachShadow" in r.prototype && !("prototype" in r.prototype.attachShadow), u = function (e, o) {
            ...
            var r = h(e.ownerDocument), a = e.appendChild(r("style", {type: "text/css"})),
            ...
            if (((u === c || u === "gist." + c) && "archive" === f[3] || u === c && "releases" === f[3] && ("download" === f[4] || "latest" === f[4] && "download" === f[5]) || u === "codeload." + c) && (d.target = "_top"), "true" === b(o["data-show-count"]) && u === c && "marketplace" !== f[1] && "sponsors" !== f[1] && "orgs" !== f[1] && "users" !== f[1] && "-" !== f[1]) {
                var g, m;
                if (!f[2] && f[1]) m = "followers", g = "?tab=followers"; else if (!f[3] && f[2]) m = "stargazers_count", g = "/stargazers"; else if (f[4] || "subscription" !== f[3]) if (f[4] || "fork" !== f[3]) {
    ...
    o.protocol + "//" + o.host + o.pathname === i ? E(e.body, v(window.name || o.hash.replace(/^#/, "")), (function () {
        ...
        var o,
            t = e.querySelectorAll ? e.querySelectorAll("a." + n) : (o = [], u(e.getElementsByTagName("a"), (function (e) {
